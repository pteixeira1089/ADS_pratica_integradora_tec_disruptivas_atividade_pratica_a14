...
public class ProjetoService {
	...
	public Projeto getByDescricao(String descricao) {
		Optional<Projeto> projetoOpt = projetoRepository.findByProjetoDescricao(descricao);
		return projetoOpt.orElse(null); // Handle the Optional properly here;
	}

	public List<Projeto> getByDescricaoContaining(String descricao) {
